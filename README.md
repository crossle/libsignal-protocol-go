[![GoDoc](https://godoc.org/github.com/crossle/goquery?status.png)](https://godoc.org/github.com/crossle/libsignal-protocol-go)
[![Go Report Card](https://goreportcard.com/badge/github.com/crossle/libsignal-protocol-go)](https://goreportcard.com/report/github.com/crossle/libsignal-protocol-go)
...
- [API Reference](https://godoc.org/github.com/crossle/libsignal-protocol-go)
...
Install the Signal library using the "go get" command:
    ...
    go get github.com/crossle/libsignal-protocol-go/...
...
```go
import "github.com/crossle/libsignal-protocol-go/serializer"
